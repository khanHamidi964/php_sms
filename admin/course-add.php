    ...
    <div class="container mt-4 w-50">
        ...
        <div class="card p-3 my-3 shadow">
            <div class="d-flex justify-content-between">
                <h4> <i class="bi bi-box-fill"></i> Add New Course</h4>
                <a href="course.php" class="btn btn-dark"><i class="bi bi-arrow-left"></i> Go back</a>
            </div>
            <hr>
            <form method="post" action="logic/course-add.php">
                <div class="row">
                    <div class="col">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none" name="subject"
                                value="<?php if (isset($_SESSION['old_subject'])) echo $_SESSION['old_subject']['subject'] ?>">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none" name="subject_code"
                                value="<?php if (isset($_SESSION['old_subject'])) echo $_SESSION['old_subject']['subject_code'] ?>">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
