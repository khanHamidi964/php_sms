    ...
    <div class="container mt-4">
        <div class="card p-3 my-3 shadow">
            <div class="d-flex justify-content-between">
                ...
                <h4><i class="bi  bi-person-check-fill"></i> Edit Teacher</h4>
                <a href="teacher.php" class="btn btn-dark"><i class="bi bi-arrow-left"></i> Go back</a>
            </div>
            <hr>
            <form method="post" action="logic/teacher-edit.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col">
                ...
                <div class="row">
                    <div class=" col-md-4 col-lg-3  ">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none border-1" id="first_name"
                                name="first_name" value="<?= $get_single_teacher_row['fname'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4  col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none border-1" id="last_name" name="last_name"
                                value="<?= $get_single_teacher_row['lname'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none border-1" id="username" name="username"
                                value="<?= $get_single_teacher_row['username'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4  col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none border-1" id="address" name="address"
                                value="<?= $get_single_teacher_row['address'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4  col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none border-1" id="emp_number"
                                name="emp_number" value="<?= $get_single_teacher_row['employee_number']  ?>">
                        </div>
                    </div>
                    <div class="col-md-4  col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none border-1" id="phone_number"
                                name="phone_number" value="<?= $get_single_teacher_row['phone_number'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4  col-lg-3">
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control shadow-none border-1" id="qualification"
                                name="qualification" value="<?= $get_single_teacher_row['qualification'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4  col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none border-1" id="email" name="email"
                                value="<?= $get_single_teacher_row['email'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control shadow-none border-1" id="dob" name="dob"
                                value="<?= $get_single_teacher_row['date_of_birth'] ?>">
                        </div>
                    </div>
                    <div class="col-md-4  col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="radio" name="gender" value="Male"
                                <?php if ($get_single_teacher_row['gender'] == 'Male') echo 'checked' ?>>
                            Male &nbsp;&nbsp;

                            <input type="radio" name="gender" value="Female"
                                <?php if ($get_single_teacher_row['gender'] == 'Female') echo 'checked' ?>>
                            Female
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-end">
                                <img src="../<?= $get_single_teacher_row['profile'] ?>" alt=""
                                    class=" img-thumbnail my-2" style="width:200px; height:200px;  ">
                            </div>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="subject" class="form-label">All Subjects</label> <br>
                            <?php
                                    ...
                                    ?>
                            <input type="checkbox" id="subject" value="<?= $row['subject_id'] ?>" name="all_subjects[]">
                            <?= $row['subject'] ?> &nbsp;&nbsp;&nbsp;
                            <?php
                                    }
                                    ?>
                        ...
                        <br>
                        <div class="mb-3">
                            <label class="mb-2">Teacher subjects</label> <br>
                            <?php
                                    $get_single = "SELECT * FROM subjects JOIN teacher_subjects ON subjects.subject_id =
                            teacher_subjects.subject_id1 WHERE teacher_id1 = {$get_single_teacher_row['teacher_id']}";
                                    $get_single_res = mysqli_query($connection, $get_single);

                                    while ($get_wor = mysqli_fetch_assoc($get_single_res)) {

                                    ?>
                            <input type="checkbox" checked id="subject" value="<?= $get_wor['subject_id'] ?>"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="first_name" class="form-label">All Class </label> <br>
                            <?php
                                    ...
                                    $class_query = mysqli_query($connection, $classes);
                                    while ($row  = mysqli_fetch_assoc($class_query)) {
                                    ?>
                            <input type="checkbox" id="grade" value="<?= $row['class_id'] ?>" name="all_classes[]">
                        ...
                        <br>
                        <div class="mb-3">
                            <label class="mb-2">Teacher Class</label> <br>
                            <?php
                                    $get_single_grade = "SELECT * FROM teacher_class JOIN classes ON teacher_class.class_id1 = classes.class_id JOIN grades ON classes.grade_id = grades.grade_id JOIN section ON classes.section_id = section.section_id    WHERE teacher_id1 = {$get_single_teacher_row['teacher_id']}";
                                    $get_single_res_grade = mysqli_query($connection, $get_single_grade);

                                    while ($get_row = mysqli_fetch_assoc($get_single_res_grade)) {

                                    ?>
                            <input type="checkbox" checked id="grades" value="<?= $get_row['class_id'] ?>"
                                name="teacher_classes[]">
                            <?= $get_row['grade_code'] . '-' . $get_row['grade'] .  $get_row['section'] ?>
                            &nbsp;&nbsp;&nbsp;
                            <?php
                                    }
                                    ?>
        ...
        <div class="card p-3 my-3 shadow-sm">
            ...
            <h4><i class="bi bi-person-check-fill"></i> Edit Teacher Password</h4>
            <hr>
