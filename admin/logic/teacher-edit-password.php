                ...
                if (password_verify($_POST['admin_password'], $get_row['password'])) {
                    if ($new_password == $confirmNew_password) {
                        ...
                        if (empty($new_password)) {
                            ...
                            header("location:../teacher-edit.php?message=$mess&teacher_id={$_POST['teacher_id']}");
                            exit;
                        ...
                        mysqli_stmt_bind_param($password_change_query_stmt, 'i', $_POST['teacher_id']);
                        if (mysqli_stmt_execute($password_change_query_stmt)) {
                            $mess = "Teacher password successfully changed! ";
                            header("location:../teacher-edit.php?message=$mess&teacher_id={$_POST['teacher_id']}");
