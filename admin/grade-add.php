...
<body class="bg-light">
    ...
    <div class="container mt-4 w-50">
        ...
        <div class="card p-3 my-3 shadow">
            ...
            <hr>
            <form method="post" action="logic/grade-add.php">
                <div class="row">
                    <div class="col">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none border-1" id="grade" name="grade"
                                value="<?php if (isset($_SESSION['old_grade'])) echo   $_SESSION['old_grade']['grade'] ?>">
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control shadow-none border-1" id="grade_code"
                                    name="grade_code"
                                    value="<?php if (isset($_SESSION['old_grade'])) echo   $_SESSION['old_grade']['grade_code'] ?>">
                            </div>
                        </div>
